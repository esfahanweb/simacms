			...
			ed.onSetProgressState.add(function(ed, b, ti) {
				...
				if (b) {
					t.progressTimer = setTimeout(function() {
						...
						DOM.add(co, 'div', {id : id + '_blocker', 'class' : 'mceBlocker', style : {width : tb.UserWidth + 2, height : tb.UserHeight + 2}});
						DOM.add(co, 'div', {id : id + '_progress', 'class' : 'mceProgress', style : {left : tb.UserWidth / 2, top : tb.UserHeight / 2}});
					}, ti || 0);
				} else {
...
*/
		...
		resizeBy : function(dw, dh) {
			...
			this.resizeTo(e.UserWidth + dw, e.UserHeight + dh);
		},
		...
		resizeTo : function(w, h, store) {
			...
			if (s.theme_advanced_resize_horizontal) {
				...
				if (w < e.UserWidth) {
					w = e.UserWidth;
					DOM.setStyle(ifr, 'width', e.UserWidth);
				}
			}
			...
			if (s.theme_advanced_resizing) {
				...
				ed.onPostRender.add(function() {
					...
					Event.add(ed.id + '_resize', 'mousedown', function(e) {
						...
						startWidth = width = ifrElm.UserWidth;
						startHeight = height = ifrElm.UserHeight;
