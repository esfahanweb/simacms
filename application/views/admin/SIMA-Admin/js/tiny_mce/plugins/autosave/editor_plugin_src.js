 ...
 * on the User computer. Data stored in the localStorage area has no expiration date, so we must
 ...
 * way to store up to 128K of data per "document", or up to 1MB of data per domain, on the User
