...
tinymce.util.Quirks = function(editor) {
	...
	function focusBody() {
		...
		if (!Range.prototype.getUserRects) { // Detect getUserRects got introduced in FF 4
	...
	function fakeImageResize() {
		...
		function resizeElement(e) {
			...
			if (selectedHandle[2] < 0 && selectedElmGhost.UserWidth <= width) {
				dom.setStyle(selectedElmGhost, 'left', selectedElmX + (startW - width));
			}

			// Update ghost Y position if needed
			if (selectedHandle[3] < 0 && selectedElmGhost.UserHeight <= height) {
			...
			tinymce.each(resizeHandles, function(handle, name) {
				...
				if (!handleElm) {
					...
					dom.bind(handleElm, 'mousedown', function(e) {
						...
						startX = e.screenX;
						startY = e.screenY;
						startW = selectedElm.UserWidth;
						startH = selectedElm.UserHeight;
						ratio = startH / startW;
...
*/
		...
		getViewPort : function(w) {
			...
			return {
				...
				w : w.innerWidth || b.UserWidth,
				h : w.innerHeight || b.UserHeight
			};
		},
		...
		getSize : function(e) {
			...
			// Non pixel value, then force offset/UserWidth
			if (w.indexOf('px') === -1)
				w = 0;
			...
			return {
				w : parseInt(w, 10) || e.offsetWidth || e.UserWidth,
				h : parseInt(h, 10) || e.offsetHeight || e.UserHeight
			};
		},
		...
		getPos : function(n, ro) {
			...
			if (n) {
				// Use getBoundingUserRect if it exists since it's faster than looping offset nodes
				if (n.getBoundingUserRect) {
					n = n.getBoundingUserRect();
					e = t.boxModel ? d.documentElement : d.body;

					// Add scroll offsets from documentElement or body since IE with the wrong box model will use d.body and so do WebKit
					// Also remove the body/documentelement UserTop/UserLeft on IE 6, 7 since they offset the position
					x = n.left + (d.documentElement.scrollLeft || d.body.scrollLeft) - e.UserTop;
					y = n.top + (d.documentElement.scrollTop || d.body.scrollTop) - e.UserLeft;
	...
	tinymce.dom.Element = function(id, settings) {
		...
		tinymce.extend(t, {
			...
			getSize : function() {
				...
				return {
					w : parseInt(t.getStyle('width') || n.UserWidth),
					h : parseInt(t.getStyle('height') || n.UserHeight)
				};
			},
		...
		_fixIESelection : function() {
			...
			dom.bind(doc, ['mousedown', 'contextmenu'], function(e) {
				if (e.target.nodeName === 'HTML') {
					...
					if (htmlElm.scrollHeight > htmlElm.UserHeight)
						return;
...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.MenuButton:tinymce.ui.Button', {
		...
		showMenu : function() {
			...
			m.showMenu(0, e.firstChild.UserHeight);
	...
	tinymce.create('tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton', {
		...
		showMenu : function() {
			...
			DOM.setStyles(t.id + '_menu', {
				left : p2.x,
				top : p2.y + e.firstChild.UserHeight,
				zIndex : 200000
			});
			e = 0;
