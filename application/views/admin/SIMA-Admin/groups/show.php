<!-- Dynamic table -->
		...
		foreach ($query->result() as $row)
		{
   			 echo '<tr>
						...
						<td class="center"><a href="'.base_url().'admin/groups/edit/'.$row->id.'" title="" class="mr10"><img src="'.$TMPL.'/images/icons/dark/pencil.png" alt="" /></a><a href="'.base_url().'admin/groups/delete/'.$row->id.'" title="" class="mr10"><img src="'.$TMPL.'/images/icons/dark/close.png" alt="" /></a>
