    <!-- Form with validation -->
        <form action="<? echo base_url().'admin/users/add_roles'; ?>" id="valid" class="mainForm" method="post">
            <fieldset>
            
             
                <div class="widget"> 
                
                    <div class="head"><h5 class="iPencil"><? echo $this->lang->line('add_new_user_roles'); ?></h5></div>
