...
tinyMCE.init({
    ...
    <!-- Form with validation -->
        <form action="<? echo base_url().'admin/posts/edit/'.$id; ?>" id="valid" class="mainForm" method="post">
            <fieldset>
                ...
                <div class="widget"> 
                    ...
                    <div class="rowElem noborder">
                     ...
                     <div class="rowElem">
                        ...
                        <div class="formRight">
                        	<select name="cat_id" size="30">
                            <?
							 echo $Post_Select_Category_Option;
							?>
                            </select>
                    ...
                    <div class="rowElem">
                        ...
                        <div class="formRight">
                            ...
                            <textarea class="" name="story" id="story"><? echo $story; ?></textarea>
                        </div>
                        <div class="fix"></div>
                    </div>
