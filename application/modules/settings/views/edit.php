...
<div class="formRight">
<input type="text" class="" name="email" id="email" value="<?=$email?>" />
</div>
<div class="fix"></div>
</div>
<!------------------------------------------------------->
...
<div class="formRight">
<input type="text" class="" name="domain" id="domain" value="<?=$domain?>" />
</div>
<div class="fix"></div>
</div>
<!------------------------------------------------------->
...
<div class="formRight">
<input type="text" class="" name="copyright_text" id="copyright_text" value="<?=$copyright_text?>" />
</div>
<div class="fix"></div>
</div>
<!------------------------------------------------------->
