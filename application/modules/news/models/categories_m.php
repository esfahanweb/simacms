...
class Categories_m extends CI_Model {
	...
	{				
		...
		if($query->num_rows() > 0)
		{
			...
			# Load Admin Edit Template
			$this->load->view('admin/categories/edit', $categories); 	
		}
		else
		{
			# Show Error
	...
	{			
		...
		# Show Success Page
		$this->admin_init->Show_Success_Page($this->lang->line('edit_user_success'), base_url().'admin/news/categories/show');
	}
	...
	function show_search()
	{
		...
		foreach ($categories as $item)
		{
			$categories_output .= 
				...
				<td>
				<a href="'.base_url().'admin/news/categories/edit/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/pencil.png" /></a>
				<a href="'.base_url().'admin/news/categories/delete/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/close.png" /></a>
				</td>
				</tr>';
		}		
