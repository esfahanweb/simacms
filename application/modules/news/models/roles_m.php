	...
	function show_search()
	{
		...
		foreach ($roles as $item)
		{
			$roles_output .= 
				...
				<td>'.$item['url'].'</td>
				<td>
				<a href="'.base_url().'admin/users/roles/edit/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/pencil.png" /></a>
				<a href="'.base_url().'admin/users/roles/delete/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/close.png" /></a>
				</td>
				</tr>';
		}		
		return $roles_output;
