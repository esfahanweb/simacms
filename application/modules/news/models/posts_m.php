	...
	function show_search()
	{
		...
		foreach ($posts as $item)
		{
			$posts_output .= 
				...
				<td>'.$item['status'].'</td>
				<td>
				<a href="'.base_url().'admin/news/posts/edit/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/pencil.png" /></a>
				<a href="'.base_url().'admin/news/posts/delete/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/close.png" /></a>
				</td>
				</tr>';
		}		
		return $posts_output;
