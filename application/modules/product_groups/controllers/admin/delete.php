...
class Delete extends CI_Controller {
	...
	{
		# Load Product Groups Language File
		$this->lang->load('product_groups', $this->admin_init->Admin_Language);
		
		# Load Page Title From Language File
		$page_title = $this->lang->line('delete_group');
		...
		if( $this->admin_init->Admin_Logged_In() )
		{
			...
			{	
				...
				{		
					$this->product_groups->delete_form($id);		
				}
				# Run If Data Sent By Form
				else
				{
					$this->product_groups->delete_data($id);
				}				
			}
