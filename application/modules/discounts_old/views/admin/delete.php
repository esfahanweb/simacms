...
<form action="<? echo base_url().'admin/discounts/delete/'.$id; ?>" id="valid" class="mainForm" method="post">
<fieldset>
<div class="widget"> 
...
<a href="<? echo base_url(); ?>admin/discounts/show" title="" style="float:right; padding: 3px;" class="basicBtn" ><? echo $this->lang->line('no'); ?></a>
</div>
<br />
<div class="fix"></div>
</div>
