...
function get_data()
{
	...
	$.post("<?php echo base_url().'orders/admin/add/get_product_price?id='?>"+id+'&bcycle='+bcycle+'&radio='+radio+'&currency='+currency, 
		function(data) 
		{
	...
	$.post("<?php echo base_url().'orders/admin/add/get_currency_rate?id='?>"+currency, 
		function(rate) 
		{
			$('#product_price').empty();
