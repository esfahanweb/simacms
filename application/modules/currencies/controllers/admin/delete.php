...
class Delete extends CI_Controller {
	...
	{
		# Load Currencies Language File
		$this->lang->load('currencies', $this->admin_init->Admin_Language);
		
		# Load Page Title From Language File
		$page_title = $this->lang->line('delete_discount');
		...
		if( $this->admin_init->Admin_Logged_In() )
		{
			...
			{	
				...
				{		
					$this->currencies->delete_form($id);		
				}
				# Run If Data Sent By Form
				else
				{
					$this->currencies->delete_data($id);
				}				
			}
