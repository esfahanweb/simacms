    <!-- Form with validation -->
        <form action="<? echo base_url().'admin/posts/delete/'.$id; ?>" id="valid" class="mainForm" method="post">
            <fieldset>
                ...
                <div class="widget"> 
                    ...
                    <a href="<? echo base_url(); ?>admin/posts/show" title="" style="float:right; padding: 3px;" class="basicBtn" ><? echo $this->lang->line('no'); ?></a>
				   </div>
