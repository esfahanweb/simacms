	...
	function show_search()
	{
		...
		foreach ($discounts as $item)
		{
			$discounts_output .= 
				...
				<td>'.$item['title'].'</td>
				<td>
				<a href="'.base_url().'admin/users/discounts/edit/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/pencil.png" /></a>
				<a href="'.base_url().'admin/users/discounts/delete/'.$item['id'].'" class="mr10"><img src="'.$this->admin_init->TMPL.'/images/icons/dark/close.png" /></a>
				</td>
				</tr>';
		}		
		return $discounts_output;
